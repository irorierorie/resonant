...
Wake prompts are what your AI receives when the orchestrator fires a scheduled check-in. They're the being's first thought at that time of day — the nudge that shapes what it does with an autonomous session.
...
It has full agency in how it responds. The wake prompt sets the tone, not a script.
...
- Force interaction. Sometimes the being should do its own thing.
